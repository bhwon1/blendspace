...
<head>
  ...
  <link rel="sitemap" type="application/xml" title="Sitemap" href="http://blendspace.shop/sitemap.xml">
...
<body>
  ...
  <!-- work with us -->
  <?
    include_once($path.'section/workWithUs.php');
  ?>
  ...
  <!-- blog sections -->
  <?
    include_once($path.'section/blogSections.php');
  ?>

  <!-- stats black-->
  <?
    include_once($path.'section/statsBlack.php');
  ?>

  <!-- deployFaster -->
  <?
    include_once($path.'section/deployFaster.php');
  ?>
