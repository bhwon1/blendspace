...
<head>
  ...
  <link href="<?=$path?>/css/tailus.css" rel="stylesheet">
...
<body>
  ...
  <!-- promo section -->
  <?
    include_once($path.'section/promo.php');
  ?>

   <!-- slogan section -->
   <?
    include_once($path.'section/slogan.php');
  ?>

  <!-- details -->
  <?
    include_once($path.'section/details.php');
  ?>
